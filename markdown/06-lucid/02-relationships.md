...
> NOTE:: `pivotValues` are only supported by *belongsToMany* relationship. Checkout [attach](#attachrows-pivotvalues) method documentation on how pivotValues are defined.
